...
_slog () {
    ...
    local -a literals=("--stdout" "--stderr" "--local" "--help" "--all" "-l" "-a" "-o" "-e" "-c" "-h")
    local -A literal_transitions=()
    literal_transitions[1]="([10]=1 [3]=1 [9]=1 [8]=1 [1]=1 [7]=1 [0]=1 [6]=1 [4]=1)"
    literal_transitions[3]="([10]=3 [3]=3 [9]=3 [8]=3 [1]=3 [7]=3 [0]=3 [6]=3 [4]=3)"
    literal_transitions[2]="([10]=3 [3]=3 [9]=3 [8]=3 [1]=3 [7]=3 [0]=3 [6]=3 [4]=3)"
    literal_transitions[0]="([10]=1 [3]=1 [9]=1 [8]=1 [1]=1 [7]=1 [0]=1 [6]=1 [4]=1 [5]=2 [2]=2)"
    ...
    local -A literal_transitions_level_0=()
    local -A literal_transitions_level_1=([1]="10 3 9 8 1 7 0 6 4" [3]="10 3 9 8 1 7 0 6 4" [2]="10 3 9 8 1 7 0 6 4" [0]="10 3 9 8 1 7 0 6 4 5 2")
    local -A commands_level_0=([1]="0" [3]="0 1" [2]="0 1" [0]="0")
    local -A commands_level_1=()
    local -A subword_transitions_level_0=()
    local -A subword_transitions_level_1=([1]="0" [3]="0" [2]="0" [0]="0")
