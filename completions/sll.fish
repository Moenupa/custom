# sll completion script generated by https://github.com/adaszko/complgen
function _sll_cmd_0
    set 1 $argv[1]
...
function _sll_subword_1
    ...
    _sll_subword "$mode" "$word"
end


function _sll_subword_2
    set mode $argv[1]
    set word $argv[2]
...
function _sll
    ...
    set literals "--help" "-o" "-e" "-c" "-h"

    set descrs
    set descrs[1] "Show help message and exit"
    set descrs[2] "Show stdOUT (default: false)"
    set descrs[3] "Show stdERR (default: true)"
    set descrs[4] "Color output (default: true)"
    set descr_literal_ids 1 2 3 4 5
    set descr_ids 1 2 3 4 1
    set literal_transitions_inputs
    set literal_transitions_inputs[2] "5 1 4 3 2"
    set literal_transitions_tos[2] "2 2 2 2 2"
    set literal_transitions_inputs[1] "5 1 4 3 2"
    set literal_transitions_tos[1] "2 2 2 2 2"
    set command_transitions
    set command_transitions[2] "0,2 1,2"
    set command_transitions[1] "0,2 1,2"

    set star_transitions_from 
    set star_transitions_to 
    set subword_transitions_ids[1] "1 2 3"
    set subword_transitions_tos[1] "2 2 2"
    set subword_transitions_ids[2] "1 2 3"
    set subword_transitions_tos[2] "2 2 2"
    ...
    while test $word_index -lt $COMP_CWORD
        ...
        if set --query subword_transitions_ids[$state] && test -n $subword_transitions_ids[$state]
            ...
            for subword_id in $subword_ids
                if _sll_subword_$subword_id matches "$word"
        ...
        if set --query command_transitions[$state] && test -n $command_transitions[$state]
            ...
            for cmd_to in $state_transitions
                ...
                set cmd_id $fields[1]
                set to $fields[2]
                set function_name _sll_cmd_$cmd_id
    ...
    for fallback_level in (seq 0 1)
        ...
        if test -n "$index"
            ...
            for id in $subwords
                set function_name _sll_subword_$id
        ...
        if test -n "$index"
            ...
            set function_name _sll_cmd_$function_id
...
complete --erase sll
complete --command sll --no-files --arguments "(_sll)"
